...
void MAD_BAYES (double** dist_mat, int N, double lambda, double** W, int* medoids) {
...
int main (int argc, char ** argv) {
    ...
    if (argc < 4) {
        cerr << "Usage: MAD_BAYES [dataFile] [FIX_DIM] [lambda]" << endl;
    ...
    vector<int> medoids = MAD_BAYES (dist_mat, N, lambda, W, medoids);
    // Output results
